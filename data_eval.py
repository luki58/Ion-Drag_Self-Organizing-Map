...
colors = ['g','b']
plt.figure(dpi=500)
plt.errorbar(pressure[0::2], v_mean[0::2], v_error[0::2], fmt='o', color='r', markersize=4, capsize=5, ecolor='g', label='negative polarity')
plt.errorbar(pressure[1::2], v_mean[1::2], v_error[1::2], fmt='o', color='r', markersize=4, capsize=5, ecolor='b', label='positive polarity')
