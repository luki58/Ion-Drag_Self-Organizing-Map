...
def opt_condition(param_alpha):
    ...
    f_p, e_df, c_ratio = som_output(param_alpha, iopt)
...
pbounds = {'param_alpha':(0.005,0.2)}#, 'param_endradius':(0.1,3)}
...
filtered_particles, eval_df , count_opt = som_output(alpha_opt, iopt)
